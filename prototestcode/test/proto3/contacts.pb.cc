...
PROTOBUF_CONSTEXPR Address::Address(
  ...
  , /*decltype(_impl_.work_address_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
const uint32_t TableStruct_contacts_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::contact2::Address, _impl_.home_address_),
  PROTOBUF_FIELD_OFFSET(::contact2::Address, _impl_.work_address_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::contact2::Contacts, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::contact2::Contacts, _impl_.contacts_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 40, -1, -1, sizeof(::contact2::Contacts)},
};
...
static const ::_pb::Message* const file_default_instances[] = {
  ...
  &::contact2::_Contacts_default_instance_._instance,
};

const char descriptor_table_protodef_contacts_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\016contacts.proto\022\010contact2\032\031google/proto"
  "buf/any.proto\"5\n\007Address\022\024\n\014home_address"
  "\030\001 \001(\t\022\024\n\014work_address\030\002 \001(\t\"\357\002\n\nPeopleI"
  "nfo\022\014\n\004name\030\001 \001(\t\022\013\n\003age\030\002 \001(\005\022)\n\005phone\030"
  "\003 \003(\0132\032.contact2.PeopleInfo.Phone\022\"\n\004dat"
  "a\030\004 \001(\0132\024.google.protobuf.Any\022\014\n\002qq\030\005 \001("
  "\tH\000\022\014\n\002vx\030\006 \001(\tH\000\0220\n\006remark\030\007 \003(\0132 .cont"
  "act2.PeopleInfo.RemarkEntry\032i\n\005Phone\022\016\n\006"
  "number\030\001 \001(\t\0222\n\004type\030\002 \001(\0162$.contact2.Pe"
...
const ::_pbi::DescriptorTable descriptor_table_contacts_2eproto = {
    false, false, 538, descriptor_table_protodef_contacts_2eproto,
    "contacts.proto",
...
Address::Address(const Address& from)
  ...
  _impl_.work_address_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.work_address_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_work_address().empty()) {
    _this->_impl_.work_address_.Set(from._internal_work_address(), 
      _this->GetArenaForAllocation());
  }
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "contact2.Address.home_address"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          auto str = _internal_mutable_work_address();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "contact2.Address.work_address"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* Address::_InternalSerialize(
  ...
  if (!this->_internal_home_address().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "contact2.Address.home_address");
    target = stream->WriteStringMaybeAliased(
        1, this->_internal_home_address(), target);
  }

  // string work_address = 2;
  if (!this->_internal_work_address().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_work_address().data(), static_cast<int>(this->_internal_work_address().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "contact2.Address.work_address");
    target = stream->WriteStringMaybeAliased(
        2, this->_internal_work_address(), target);
  }
...
void Address::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (!from._internal_work_address().empty()) {
    _this->_internal_set_work_address(from._internal_work_address());
  }
...
void Address::InternalSwap(Address* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.work_address_, lhs_arena,
      &other->_impl_.work_address_, rhs_arena
  );
}
    ...
    switch (tag >> 3) {
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 50)) {
          auto str = _internal_mutable_vx();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "contact2.PeopleInfo.vx"));
        } else
          goto handle_unusual;
        continue;
...
uint8_t* PeopleInfo::_InternalSerialize(
  ...
  if (_internal_has_vx()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_vx().data(), static_cast<int>(this->_internal_vx().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "contact2.PeopleInfo.vx");
    target = stream->WriteStringMaybeAliased(
        6, this->_internal_vx(), target);
  }
...
Contacts::Contacts(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:contact2.Contacts)
}
Contacts::Contacts(const Contacts& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:contact2.Contacts)
}
...
Contacts::~Contacts() {
  // @@protoc_insertion_point(destructor:contact2.Contacts)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
void Contacts::Clear() {
// @@protoc_insertion_point(message_clear_start:contact2.Contacts)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
uint8_t* Contacts::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:contact2.Contacts)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:contact2.Contacts)
  return target;
}

size_t Contacts::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:contact2.Contacts)
  size_t total_size = 0;
...
void Contacts::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:contact2.Contacts)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:contact2.Contacts)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::contact2::Contacts*
Arena::CreateMaybeMessage< ::contact2::Contacts >(Arena* arena) {
  return Arena::CreateMessageInternal< ::contact2::Contacts >(arena);
}
